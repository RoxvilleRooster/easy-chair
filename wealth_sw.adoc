...
== Wealth rules in SWADE Core

New statistic: Wealth (die roll)
...
Poverty hindrance decreases the Wealth die by 1 step.
Rich edge increases the Wealth die by 1 step. Very Rich edge increases the Wealth die by 1 more step.
Fame edge adds +1 to Wealth rolls.
Famous edge adds another +1 to Wealth rolls.




== Determine the setting's starting funds

Typically the setting's starting funds is $500; some settings use $1000.
