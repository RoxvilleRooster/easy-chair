...
Suggested Edges::
Acrobat, Alertness, Beast Bond, Beast Master, Brawny, Combat Acrobat, Danger Sense, Fleet-Footed, Free Runner, Giant Killer, Iron Jaw, Woodsman
Suggested Hindrances::
...
Suggested Edges::
Ambidextrous, Block, Brawler, Brawny, Bruiser, Brute, Combat Reflexes, Fame, First Strike, Frenzy, Improved Block, Improved Frenzy, Iron Jaw, Martial Artist, Quick, Strong Willed, Sweep, Two Fisted
Suggested Hindrances::
...
Suggested Edges::
Acrobat, Ambidextrous, Block, Chi, First Strike, Frenzy, Martial Artist, Martial Warrior,
Suggested Hindrances::
...
Suggested Skills::
Athletics, Battle, Fighting, Intimidation, Notice, Shooting, Stealth
Suggested Edges::
Enlisted;;
...
Suggested Skills::
Athletics, Fighting, Intimidation, Performance, Taunt
Suggested Edges::
